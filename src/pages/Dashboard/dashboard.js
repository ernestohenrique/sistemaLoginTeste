        ...
        <>
          {chamados.length === 0 ? (
            <div className="botoes col-6 col-md-12">
              ...
              <div className="teste">
                <button className="btn" type="submit" id="myButton">
                  <Link to="/new">
            ...
            <>
              <div className="botoes col-6 col-md-12">
                <div className="teste">
                  <Link to="/new" className="btnovochamado">
                    <button
                ...
                <nav aria-label="Page navigation example">
                  <ul className="pagination justify-content-center">
                    <li className="page-item">
                      <button className="btn btn-success" onClick={handleMore}>
                        Próxima
                      </button>
                    </li>
                    <li className="page-item">
